...
def home(request, option):
    ...
    path = f"/Users/neilgopal/slowed-reverb/slowreverb/static/audio/{url[32:43]}.wav"    
    ...
    if "convert" == option:
        ...
        fx(path, f"/Users/neilgopal/slowed-reverb/slowreverb/static/audio/res-{url[32:43]}.wav")
